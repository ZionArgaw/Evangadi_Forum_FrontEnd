...
//Uses React's useState for managing component state and useContext to interact with global state via UserContext.
import { Link, useNavigate } from "react-router-dom";
// Utilizes useNavigate from React Router to programmatically navigate users after successful login.
import axios from "../../axios/axiosConfig";
// Axios: Configured instance for making HTTP requests.
